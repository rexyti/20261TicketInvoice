...
### Operación de Eventos y Control de Accesos (Módulo 2)
Suministra el estado final de los tickets (validado, no asistió, cancelado, cortesía), información necesaria para calcular los porcentajes de pago y la distribución final del recaudo.
